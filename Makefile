...
all:
	gcc -g -Wall ./src/main.c ./src/file_img.c ./src/engine.c -I $(INCLUDE_APP) -I $(INCLUDE_GLFW) -I $(INCLUDE_GLEW) -L $(LIB_GLFW) -l glfw3dll -L $(LIB_GLEW) -l glew32.dll -l opengl32 -o ./build/openvice
